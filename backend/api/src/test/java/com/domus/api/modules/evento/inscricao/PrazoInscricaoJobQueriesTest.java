...
class PrazoInscricaoJobQueriesTest implements PostgresTestContainerSupport {
    ...
    @Sql(statements = {
        ...
        "INSERT INTO pessoa (id, igreja_id, nome, email) VALUES "
            + "('33333333-3333-3333-3333-333333333334', '11111111-1111-1111-1111-111111111111', 'Outro', 'outro@teste.com')",
        "INSERT INTO evento (id, igreja_id, titulo, inicio_em, requer_inscricao) VALUES "
            + "('22222222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111', 'Congresso', "
            + "now() + interval '30 days', true), "
            + "('22222222-2222-2222-2222-222222222223', '11111111-1111-1111-1111-111111111111', 'Outro Evento', "
            + "now() + interval '30 days', true)",
        "INSERT INTO inscricao_evento (id, igreja_id, evento_id, pessoa_id, status, aviso_prazo_incompleto_em) VALUES "
            ...
            + "'22222222-2222-2222-2222-222222222223', '33333333-3333-3333-3333-333333333334', 'AGUARDANDO_PAGAMENTO', NULL)"
    })
    ...
    @Sql(statements = {
        ...
        "INSERT INTO pessoa (id, igreja_id, nome, email) VALUES "
            ...
            + "('33333333-3333-3333-3333-333333333336', '11111111-1111-1111-1111-111111111111', 'D', 'd@teste.com'), "
            + "('33333333-3333-3333-3333-333333333337', '11111111-1111-1111-1111-111111111111', 'E', 'e@teste.com'), "
            + "('33333333-3333-3333-3333-333333333338', '11111111-1111-1111-1111-111111111111', 'F', 'f@teste.com')",
        "INSERT INTO evento (id, igreja_id, titulo, inicio_em, requer_inscricao) VALUES "
            + "('22222222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111', 'Congresso', "
            + "now() + interval '30 days', true), "
            + "('22222222-2222-2222-2222-222222222223', '11111111-1111-1111-1111-111111111111', 'Outro Evento', "
        ...
        "INSERT INTO inscricao_evento (id, igreja_id, evento_id, pessoa_id, status) VALUES "
            ...
            + "('55555555-5555-5555-5555-555555555554', '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222223', '33333333-3333-3333-3333-333333333336', 'CONFIRMADA'), "
            + "('55555555-5555-5555-5555-555555555555', '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222223', '33333333-3333-3333-3333-333333333337', 'CONFIRMADA'), "
            + "('55555555-5555-5555-5555-555555555556', '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222223', '33333333-3333-3333-3333-333333333338', 'CONFIRMADA')"
    })
    void contaPorStatus() {
